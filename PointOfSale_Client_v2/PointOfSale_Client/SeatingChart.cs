...
namespace PointOfSale_Client
{
    ...
    public partial class SeatingChart : Form
    {
        ...
        Dictionary<int, Button> TableNumLookup = new Dictionary<int, Button>();

        Button CurrentTableSelected = null;
        ...
        public SeatingChart()
        {
            ...
            MessageManager.OnOrderPaymentRecieved += OnOrderPaymentMessageRecieved;
            MessageManager.OnUpdateTableStatusMessageRecieved += OnTableMessageRecieved; 
            //MessageManager.KitchenStatusChanged += OnKitchenStatusChanged;
        }

        private void OnTableMessageRecieved(MessageBase Message)
        {
            UpdateTableStatusMessage updateTableStatusMessage = (UpdateTableStatusMessage)Message;
            TableLookup[TableNumLookup[updateTableStatusMessage.TableNum]].CurrentStatus = updateTableStatusMessage.UpdatedTableStatus;
            TableLookup[TableNumLookup[updateTableStatusMessage.TableNum]].UpdateStatus(true);
        }

        private void OnOrderPaymentMessageRecieved(MessageBase Message)
        {
        ...
        private void OnOrderUpdateMessageRecieved(MessageBase Message)
        {
            ...
            TableLookup[TableNumLookup[orderUpdatedMessage.FullOrder.TableNumber]].UpdateOrderFromServer(orderUpdatedMessage.FullOrder);
        }
        ...
        private void SetupTables()
        {
            ...
            {
                TableNumLookup.Add(Table.Value.TableNumber, Table.Key);
            }
        }
